...
static THD_FUNCTION(Magwick, arg)
{
    ...
    while( true )
    {
        ...
        measured_magnetic_lines.x = magnetometer_data[0];
        measured_magnetic_lines.y = magnetometer_data[1];
        measured_magnetic_lines.z = -magnetometer_data[2];
        ...
        quaternion_t f_a = quatSubtract(quatRotate(real_acceleration, base), measured_acceleration);
        quaternion_t f_m = quatSubtract(quatRotate(real_magnetic_lines, base), measured_magnetic_lines);
